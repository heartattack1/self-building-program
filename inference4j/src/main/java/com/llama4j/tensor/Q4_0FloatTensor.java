...
public final class Q4_0FloatTensor extends FloatTensor {
    ...
    /**
     * Creates a Q4_0 tensor.
     *
     * @param size number of elements
     * @param memorySegment tensor data segment
     */
    public Q4_0FloatTensor(int size, java.lang.foreign.MemorySegment memorySegment) {
        this.size = size;
    ...
    /**
     * Vectorized dot product specialized for Q4_0 weights.
     *
        ...
        for (; j < upperBound; j += GGMLType.Q4_0.getBlockSize(), blockOffset += GGMLType.Q4_0.getTypeSize()) {
            ...
            switch (F_SPECIES.vectorBitSize()) {
                case 512 -> {
                    ...
                    var sum2 = that.getFloatVector(F_SPECIES, thatOffset + j + F_SPECIES.length())
                ...
                case 128 -> {
                    for (int i = 0; i < 2; ++i) {
                        ...
                        var sum0 = that.getFloatVector(F_SPECIES, thatOffset + j + (i * 4) * F_SPECIES.length())
